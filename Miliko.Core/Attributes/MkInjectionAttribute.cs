//       ========================
//       Miliko.Core::MkInjectionAttribute.cs
...
namespace Miliko.API.Attributes
{
	...
	public abstract class MkInjectionAttribute : MkInjectionBuilderAttribute
	{
		...
		/// </summary>
		/// <returns></returns>
		public sealed override MkInjectionAttribute Build() => this;
		...
		/// <summary>
		/// Perform any clean-up work to "de-ject" the injectable after the container has finished executing.
		/// </summary>
