//       ========================
//       Lilikoi::LkParameterBuilderAttribute.cs
...
public abstract class LkParameterBuilderAttribute : Attribute
{
	...
	/// <summary>
	///     Whether or not this parameter can handle an input of <see cref="TInput" /> and provide an
	///     output of <see cref="TParameter" />.
	/// </summary>
